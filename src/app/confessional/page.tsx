  ...
  return <main className="confPage">
    ...
    <section className="confExperience" id="experience">
      ...
      <div className="confExperienceBooth" data-conf-reveal>
        <div className="confExperienceBoothMedia"><Image src="/assets/spill/confessional/hero.png" alt="The self-contained SPILL Confessional booth" fill sizes="(max-width: 900px) 100vw, 48vw" /></div>
    ...
    <section className="confFuture">
      ...
      <div className="confBigger"><Image src="/assets/spill/confessional/hero.png" alt="" fill sizes="100vw" /><div className="confBiggerVeil" /><div data-conf-reveal><p className="confKicker">The bigger opportunity</p><h2>A private place<br />to say something<br /><em>real.</em></h2><p>Then an experience + revenue source + content engine + customer acquisition tool + sponsorship platform + event product + creator discovery channel + hardware product + software business + physical media network.</p><strong>SPILL CONFESSIONAL<br />Step in. Sit down. SPILL.</strong><div className="actions"><Link className="button primary" href="/create">Book a Confessional</Link><Link className="button secondary" href="/partner">Bring Confessional to an event</Link></div></div></div>
    </section>
  </main>;
}
