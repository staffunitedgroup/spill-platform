...
export default function PodcastPage() {
  return <main className="podcastPage">
    ...
    <section className="podSection podCapabilities">
      <div className="podSectionIntro" data-pod-reveal><SectionLabel>17 / Complete production support</SectionLabel><h2>What <SpillWordmark /><br /><em>can handle.</em></h2></div>
    ...
    <section className="podLocations">
      ...
      <div className="podLocationGrid">
        <Link href="/saigon/podcast" data-pod-reveal><span>01 / Launching soon</span><h3><SpillWordmark /> Saigon</h3><p>Professional podcast production in Saigon.</p><b>SPILL Podcast Saigon →</b></Link>
        <Link className="coming" href="/tokyo/podcast" data-pod-reveal><span>02 / Coming next</span><h3><SpillWordmark /> Tokyo</h3><p>Tokyo stories, culture, creators, and partnerships within the SPILL production system.</p><b>SPILL Podcast Tokyo →</b></Link>
      </div>
    </section>
