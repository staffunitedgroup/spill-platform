...
export const localPageContent: Record<string, { title: string; description: string; note?: string; sections: PortalSection[] }> = {
  ...
  create: { title: "Create at SPILL", description: "Record, broadcast, perform, host, collaborate, and share your story from SPILL Saigon.", sections: [
    { title: "Podcast", text: "Professional podcast creation and production." }, { title: "Livestream", text: "Live digital broadcasting and social distribution." }, { title: "Confessional", text: "Short-form storytelling and content creation." }, { title: "Perform", text: "For musicians, comedians, speakers, artists, and creators." }, { title: "Host an Event", text: "For meetups, launches, panels, workshops, private events, and community gatherings." }, { title: "Creator Opportunities", text: "Collaborations, editorial invitations, sponsor-funded opportunities, and SPILL content." },
  ] },
